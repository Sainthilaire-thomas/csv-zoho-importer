...
function AnomalyBadge({ type }: { type: AnomalyType }) {
  ...
  const colors: Record<AnomalyType, string> = {
    ...
    datetime_truncated: 'bg-blue-200 text-blue-800 dark:bg-blue-800 dark:text-blue-200',
    spaces_trimmed: 'bg-blue-200 text-blue-800 dark:bg-blue-800 dark:text-blue-200',
