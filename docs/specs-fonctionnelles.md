...
**Impact** : Import échoue pour les utilisateurs fréquents  
**Probabilité** : Moyenne  
**Mitigation** : 
...
**Impact** : Nombreux échecs de validation  
**Probabilité** : Élevée  
**Mitigation** :
...
**Impact** : Timeouts sur fichiers > 50 MB  
**Probabilité** : Faible  
**Mitigation** :
...
**Impact** : Breaking changes nécessitant adaptation  
**Probabilité** : Faible  
**Mitigation** :
